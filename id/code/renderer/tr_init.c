...
void GfxInfo_f( void ) 
{
	...
	ri.Printf( PRINT_ALL, "MODE: %d, %d x %d %s hz: %d", r_mode->integer, glConfig.vidWidth, glConfig.vidHeight, fsstrings[r_fullscreen->integer == 1], glConfig.displayFrequency );
