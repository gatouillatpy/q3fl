...
open(CPP, "gl_base.c") || die "$!";

print "/**** This file is autogenerated. Run GenerateQGL.pl to update it ****/\n\n";

print "#include \"gl_wrapper.h\"\n\n";

print "extern void trace( char* fmt, ... );\n\n";
...
print "inline static GLenum _glGetError( void )\n";
print "{\n";
...
#        print "argName='$argName'\n";
    ...
    print "inline static $type q$name($argString)\n";
    print "{\n";
